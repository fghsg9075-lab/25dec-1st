            ...
            <div className="p-6">
                ...
                <div className="bg-blue-50 p-4 rounded-2xl border border-blue-100 mb-4">
                    ...
                    <div className="flex gap-2 mb-2">
                        {/* NORMAL MCQ */}
                        <button 
                            onClick={() => canAccess(1, 'MCQ_SIMPLE') && onSelect('MCQ_SIMPLE', 10)}
                            className={`flex-1 flex flex-col items-center justify-center p-3 bg-white rounded-xl font-bold text-xs transition-all border border-blue-200 text-center gap-1 ${
                                canAccess(1, 'MCQ_SIMPLE') ? 'hover:bg-blue-50 text-blue-800' : 'opacity-50 cursor-not-allowed text-slate-400'
                            }`}
                        >
                            <span>Normal MCQ</span>
                            <span className="bg-blue-100 px-2 py-0.5 rounded text-[9px]">
                                {canAccess(1, 'MCQ_SIMPLE') && user.isPremium ? 'FREE' : '1 CR'}
                            </span>
                        </button>
                        ...
                        <button 
                            ...
                            className={`flex-1 flex flex-col items-center justify-center p-3 bg-white rounded-xl font-bold text-xs transition-all border border-purple-200 text-center gap-1 ${
                                canAccess(2, 'MCQ_ANALYSIS') ? 'hover:bg-purple-50 text-purple-800' : 'opacity-50 cursor-not-allowed text-slate-400'
                            }`}
                        >
                            <span>Premium MCQ</span>
                            <span className="bg-purple-100 px-2 py-0.5 rounded text-[9px]">
                                {canAccess(2, 'MCQ_ANALYSIS') && user.isPremium ? 'FREE' : '2 CR'}
                            </span>
                        </button>
                    </div>
